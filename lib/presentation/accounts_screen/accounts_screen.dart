...
class AccountsScreen extends GetWidget<AccountsController> {
  ...
  Widget _buildAccountsGrid() {
    return Obx(() => GridView.builder(
        ...
        itemCount:
            controller.accountsModelObj.value.accountsgridItemList.value.length,
        itemBuilder: (context, index) {
          AccountsgridItemModel model = controller
              .accountsModelObj.value.accountsgridItemList.value[index];
          return AccountsgridItemWidget(model);
        }));
  }

  /// Section Widget
  Widget _buildRenewOneColumn() {
    return Container(
  ...
  /// Section Widget
  Widget _buildAppleTwentyOneColumn() {
    return Container(
        padding: EdgeInsets.all(20.h),
        decoration: AppDecoration.white
            .copyWith(borderRadius: BorderRadiusStyle.roundedBorder17),
