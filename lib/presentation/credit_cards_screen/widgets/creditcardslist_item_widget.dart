      ...
      child: Row(
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Obx(
                  () => Text(
                    creditcardslistItemModelObj.cardType!.value,
                ...
                Obx(
                  () => Text(
                    creditcardslistItemModelObj.secondary!.value,
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Obx(
                  () => Text(
                    creditcardslistItemModelObj.bank!.value,
                    style: theme.textTheme.titleSmall,
                  ),
                ),
                SizedBox(height: 4.v),
                Obx(
                  () => Text(
                    creditcardslistItemModelObj.dBLBank!.value,
                    style: theme.textTheme.bodySmall,
                  ),
                ),
              ],
          ...
          Padding(
            ...
            child: Obx(
              () => Text(
                creditcardslistItemModelObj.viewDetails!.value,
