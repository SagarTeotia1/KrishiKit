...
class HomeScreen extends GetWidget<HomeController> {
                        ...
                        Align(
                            ...
                            child: Row(children: [
                              ...
                              Padding(
                                  ...
                                  child: _buildNov(nov: "lbl_aug".tr)),
                              Padding(
                                  padding: EdgeInsets.only(left: 14.h),
                                  child: _buildDec(dec: "lbl_sep".tr)),
                              Padding(
                                  padding: EdgeInsets.only(left: 16.h),
                                  child: _buildJan(userName: "lbl_oct".tr)),
                              Padding(
                                  padding: EdgeInsets.only(left: 14.h),
                                  child: _buildNov(nov: "lbl_nov".tr)),
                              Padding(
                                  padding: EdgeInsets.only(left: 13.h),
                                  child: _buildDec(dec: "lbl_dec".tr)),
                              Padding(
                                  padding: EdgeInsets.only(left: 15.h),
                                  child: _buildJan(userName: "lbl_jan".tr))
                            ])),
                        CustomImageView(
  ...
  /// Common widget
  Widget _buildNov({required String nov}) {
  ...
  /// Common widget
  Widget _buildDec({required String dec}) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      CustomImageView(
          imagePath: ImageConstant.imgGroupBlueGray40001,
          height: 4.v,
