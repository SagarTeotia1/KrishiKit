...
class InvestmentsScreen extends GetWidget<InvestmentsController> {
  ...
  /// Section Widget
  Widget _buildMoneyBagOfDollars() {
    return Obx(
      () => ListView.separated(
        ...
        itemCount: controller
            .investmentsModelObj.value.moneybagofdollarsItemList.value.length,
        itemBuilder: (context, index) {
          MoneybagofdollarsItemModel model = controller
              .investmentsModelObj.value.moneybagofdollarsItemList.value[index];
  ...
  Widget _buildAppleStore() {
    return Obx(
      () => ListView.separated(
        ...
        itemCount: controller
            .investmentsModelObj.value.applestoreItemList.value.length,
        itemBuilder: (context, index) {
          ApplestoreItemModel model = controller
              .investmentsModelObj.value.applestoreItemList.value[index];
